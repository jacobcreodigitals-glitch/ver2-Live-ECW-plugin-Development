  ...
  const run = () => {
    document.querySelectorAll(".ecw-gallery-widget").forEach((gallery) => {
      ...
      const hardReset = () => {
        ...
        gsap.set(items[expandIndex], {
          x: 0,
          y: 0,
          clearProps: "transform,width,height,position,top,left,zIndex",
        });

        gsap.set(inner, {
          clearProps: "minWidth,minHeight,transform,width,height",
        });
